...
```{r}
library(ape)
my.tree<-rcoal(n=10) #simulates a tree with standard constant 1 population size
...
5. Any R function for defining $N_{e}$ ---Julia: phylodyn ///phylosym
...
data.hiv<-heterochronous.gp.stat(out.tree)

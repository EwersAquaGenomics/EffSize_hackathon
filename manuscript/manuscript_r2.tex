...
Alternatively, if we have reasons to assume that $N_{e}$ is constant over time, and our data consist of allele frequencies, perhaps from.. then ... Christine method here. 
